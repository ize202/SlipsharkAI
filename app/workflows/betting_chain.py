...
try:
    ...
    try:
        ...
        try:
            ...
            try:
                # Try relative import with lowercase
                from ..functions.llm_functions import analyze_query, quick_research, deep_research, generate_final_response
            except ImportError:
                try:
                    ...
                    try:
                        # Try direct import with lowercase
                        from functions.llm_functions import analyze_query, quick_research, deep_research, generate_final_response
